...
#### 3. In-Class WODs
   As I stated earlier, I used ChatGPT probably twice at most. And specifically on the pure JavaScript coding WODs. The decision to use AI here was mostly motivated by my own desire to not <i>kill</i> my grade. The reality is that a failed WOD is the loss of 100 points in my overall grade. I am currently in good standings for this class, but I <strong>still</strong> feel the effects of the WODs I did fail.
#### 4. Essays
